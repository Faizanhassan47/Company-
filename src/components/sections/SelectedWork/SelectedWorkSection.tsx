  ...
  return (
    <section className="section work-section" id="work">
      <div className="container">
        ...
        {cgm && (
          <div className="sticky-card-wrapper" style={{ '--card-index': 0 } as React.CSSProperties}>
            <motion.article 
        ...
        {dome && (
          <div className="sticky-card-wrapper" style={{ '--card-index': 1 } as React.CSSProperties}>
            <motion.article 
        ...
        {matrix && (
          <div className="sticky-card-wrapper" style={{ '--card-index': 2 } as React.CSSProperties}>
            <motion.article 
              className="featured-project project-matrix" 
              data-cursor="view"
              initial="hidden"
        ...
        {grn && (
          <div className="sticky-card-wrapper" style={{ '--card-index': 3 } as React.CSSProperties}>
            <motion.article 
        ...
        {shoestops && (
          <div className="sticky-card-wrapper" style={{ '--card-index': 4 } as React.CSSProperties}>
            <motion.article 
        ...
        {comments && (
          <div className="sticky-card-wrapper" style={{ '--card-index': 5 } as React.CSSProperties}>
            <motion.article 
        ...
        {transcend && (
          <div className="sticky-card-wrapper" style={{ '--card-index': 6 } as React.CSSProperties}>
            <motion.article 
